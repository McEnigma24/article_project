...
void Setuper::setup_scene_0(Scene* scene, const string& name)
{
    ...
    // Manual
    {
        ...
        // unit separation = u(0.5);													// MAIN -
        // blurry shadow unit light_source_side = u(25) * separation; for (unit y{}; y < light_source_side; y +=
        // separation)
        //{
...
void Setuper::setup_scene_1(Scene* scene, const string& name)
{
    ...
    {
        unit rad = u(1000);
        // LEFT side														SECONDARY is blocked
        // by this
