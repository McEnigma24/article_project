...
void Setuper::setup_Global_Variables___and___Clear_Stats()
{
    ...
    // CAMERA
    G::Camera::pos = d3(u(G::WIDTH / 2), u(G::HEIGHT / 2),
                        u(
                            //-1000000.0		// 1'000'000
                            //-100000.0			// 100'000
                            -10000.0 // 10'000
...
#define setup_END                                                                                                      \
    ...
    ASSERT_ER_IF_TRUE(scene->scene_empty());
...
void Setuper::setup_scene_0(Scene* scene, const string& name)
{
    ...
    // Manual
    {
        ...
        // unit separation = u(0.5);													// MAIN - blurry
        // shadow unit light_source_side = u(25) * separation; for (unit y{}; y < light_source_side; y += separation)
        //{
        ...
        // scene->add_light(
        //	d3(u(G::WIDTH / 2 + 150), u(G::HEIGHT / 2 - 150), (z_plane - u(175))),	// SECOND LIGHT shadow
        //brightener
        //	//RGB(0, 0, 255)
        //	RGB(255, 255, 255)
        //);
        ...
        for (int y = -rad; y < rad; y++)
        {
            ...
            {
                // scene->add_sphere(
                //	d3(u((G::WIDTH / 2) + x * 300), u((G::HEIGHT / 2) + y * 300), z_plane + u(100)), u(50),
                //// DEAD CENTER 	0.0f, 0.0f, Surface_type::diffuse, 	RGB(0, 255, 0));
            }
        }
...
void Setuper::setup_scene_1(Scene* scene, const string& name)
{
    ...
    {
        scene->add_light(d3(center.x, center.y - 275, center.z - 2000), RGB(255, 255, 255));
    }

    // "BOX"
    {
        unit rad = u(1000);
        // LEFT side														SECONDARY is blocked by
        // this
        scene->add_sphere(d3(0 - rad + u(50), center.y, center.z), rad * 1.4f, u(0), u(0),
                          // Surface_type::mirror,
                          Surface_type::diffuse, RGB(255, 0, 0));

        // RIGHT side
        scene->add_sphere(d3(G::WIDTH + rad - u(50), center.y, center.z), rad * 1.4f, u(0), u(0),
                          // Surface_type::mirror,
                          Surface_type::diffuse, RGB(0, 255, 0));

        // UP side															SECONDARY ray hits
        // this
        scene->add_sphere(d3(center.x, 0 - rad + u(50), center.z), rad * 1.4f, u(0), u(0),
                          // Surface_type::mirror,
                          Surface_type::diffuse, RGB(0, 0, 255));

        // DOWN side
        scene->add_sphere(d3(center.x, G::HEIGHT + rad - u(50), center.z), rad * 1.4f, u(0), u(0),
                          // Surface_type::mirror,
                          Surface_type::diffuse, RGB(255, 140, 0));

        // BACKGROUND
        scene->add_sphere(d3(center.x, center.y, center.z + rad + u(50)), rad * 1.4f, u(0), u(0),
                          // Surface_type::mirror,
    ...
    // spheres inside
    {
        ...
        scene->add_sphere(d3(center.x - u(2.3) * rad, center.y, z_plane), rad, u(0), u(0), Surface_type::diffuse,
                          RGB(0, 0, 250));

        scene->add_sphere(d3(center.x, center.y, z_plane), rad, u(0), u(0), Surface_type::diffuse,
                          // Surface_type::mirror,
                          RGB(0, 250, 0));
...
void Setuper::setup_scene_2(Scene* scene, const string& name)
{
    ...
    // "BOX"
    {
        ...
        // LEFT side														SECONDARY is blocked by
        // this
        scene->add_sphere(d3(0 - rad + u(50), center.y, center.z), rad * 1.4f, u(0), u(0), Surface_type::mirror,
                          // Surface_type::diffuse,
                          RGB(255, 0, 0));

        // RIGHT side
        scene->add_sphere(d3(G::WIDTH + rad - u(50), center.y, center.z), rad * 1.4f, u(0), u(0), Surface_type::mirror,
                          // Surface_type::diffuse,
                          RGB(0, 255, 0));
...
void Setuper::setup_scene_3(Scene* scene, const string& name)
{
    ...
    // 3 o�wietlaj�ce wszystkie
    {
        ...
        scene->add_light(d3(center.x - diviadion, center.y - 275, center.z - 2000), RGB(255, 255, 255));
        //, RGB(0, 255, 0));
    ...
    // "BOX"
    {
        unit rad = u(1000);
        // LEFT side
        scene->add_sphere(d3(0 - rad + u(50), center.y, center.z), rad * 1.4f, u(0), u(0), Surface_type::diffuse,
                          RGB(255, 0, 0));

        // RIGHT side
        scene->add_sphere(d3(G::WIDTH + rad - u(50), center.y, center.z), rad * 1.4f, u(0), u(0), Surface_type::diffuse,
                          RGB(0, 255, 0));

        // UP side
        scene->add_sphere(d3(center.x, 0 - rad + u(50), center.z), rad * 1.4f, u(0), u(0), Surface_type::diffuse,
                          RGB(0, 0, 255));
        ...
        // BACKGROUND
        scene->add_sphere(d3(center.x, center.y, center.z + rad + u(50)), rad * 1.4f, u(0), u(0), Surface_type::diffuse,
                          // RGB(150, 0, 150)
                          RGB(230, 230, 230));
    }
    ...
    // spheres inside
    {
        ...
        scene->add_sphere(d3(center.x, center.y, z_plane), rad, u(0), u(0), Surface_type::diffuse, RGB(0, 255, 0));
...
void Setuper::setup_scene_5(Scene* scene, const string& name)
{
    ...
    {
        // G��WNE
        scene->add_light(d3(center.x, G::HEIGHT - u(1500), center.z + u(6000)), RGB(255, 255, 255));
    }

    // POD�O�E
    {
        scene->add_sphere(ground, rad, u(0), u(0), Surface_type::diffuse,
                          // Surface_type::mirror,
                          // RGB(255, 140, 0)
                          RGB(109, 114, 122));
    }
    ...
    // KILKA MA�YCH
    {
        ...
        {
            //// Du�a
            scene->add_sphere(d3(center.x - u(350), y, center.z + rad - u(3000)), u(200), u(0), u(0),
                              Surface_type::diffuse,
                              // Surface_type::mirror,
                              RGB(255, 0, 123));

            //// �rednia
            scene->add_sphere(d3(center.x, y + u(50), center.z + rad - u(3000)), u(150), u(0), u(0),
                              Surface_type::diffuse, RGB(0, 255, 123));

            //// Ma�a
            scene->add_sphere(d3(center.x + u(260), y + (88), center.z + rad - u(3000)), u(112), u(0), u(0),
                              Surface_type::diffuse, RGB(123, 0, 255));
        }
...
#define one_small_sphere(r, g, b, x, y, z)                                                                             \
    {                                                                                                                  \
        scene->add_sphere(d3(u(x), u(y), u(z)), small_rad, u(0), u(0), Surface_type::diffuse, RGB(r, g, b));           \
    }
            ...
            // Wiele ma�ych
            scene->add_sphere(d3(center.x, G::HEIGHT + u(-400), center.z + rad - u(3000)), small_rad, u(0), u(0),
                              Surface_type::diffuse, RGB(255, 140, 0));
        }
    }
...
#define one_small_sphere_mirrorr(r, g, b, x, y, z)                                                                     \
    {                                                                                                                  \
        scene->add_sphere(d3(u(x), u(y), u(z)), small_rad, u(0), u(0), Surface_type::mirror, RGB(r, g, b));            \
    }
...
void Setuper::setup_scene_9(Scene* scene, const string& name)
{
    ...
    // KILKA MA�YCH
    {
        ...
        // 3 na g�rze
        {
            ...
            scene->add_sphere(d3(center.x - u(350), y, center.z + rad - u(3000)), u(200), u(0), u(0),
                              // Surface_type::diffuse,
                              Surface_type::mirror, RGB(255, 0, 123));

            //// �rednia
            scene->add_sphere(d3(center.x, y + u(50), center.z + rad - u(3000)), u(150), u(0), u(0),
                              Surface_type::mirror, RGB(0, 255, 123));

            //// Ma�a
            scene->add_sphere(d3(center.x + u(260), y + (88), center.z + rad - u(3000)), u(112), u(0), u(0),
                              Surface_type::mirror, RGB(123, 0, 255));
        }
